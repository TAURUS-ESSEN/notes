            ...
            <span className='flex justify-end gap-1'>
                ...
                {note.status==='active' && <>            
                    ...
                    >
                        <FontAwesomeIcon
                            icon={faThumbTack}
                            className={ 'hover:scale-125 duration-300 ' + (note.pinned ? 'text-(--text-pinned) ' : 'text-(--text-notpinned) hover:text-gray-400 opacity-100 md:opacity-0 md:group-hover:opacity-100 duration-300') }
                        />                        
                    </button>
